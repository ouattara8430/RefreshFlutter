...
class Styles{
  ...
  static TextStyle headLineStyle3 = TextStyle(fontSize: 14, color: Colors.grey.shade500, fontWeight: FontWeight.w500);
  static TextStyle headLineStyle4 = TextStyle(fontSize: 17, color: Colors.grey.shade500, fontWeight: FontWeight.w500);
  static TextStyle headLineStyle5 = TextStyle(fontSize: 50, color: Colors.black87, fontWeight: FontWeight.bold);
}